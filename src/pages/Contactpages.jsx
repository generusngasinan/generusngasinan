        ...
        <div className="p-2 items-center justify-items-center grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-7 ">
          <div className="box w-mx-auto h-[350px] ">
            <div
              ...
              data-aos-delay="300"
              className="bg-sky-400 w-full h-full rounded-lg shadow-lg "
            >
              <p className="text-center pt-1 font-bold shadow-lg text-white ">
                CONTACT & ALAMAT
              </p>
              <div className="px-7 py-10">
                <p className="font-medium text-white text-sm shadow-sm mb-1 pb-2">
                ...
                <p className="font-medium flex text-white text-sm  shadow-sm mb-1 pb-2">
                  <i className="ri-map-pin-range-line pr-3 pl-2 "></i>
                  <p className="text-justify">
                    Ngasinan RT/03,Rw/13 Jebres, Kec. Jebres, Kota Surakarta,
                    Jawa Tengah 57126
                  </p>
                </p>
              </div>
          ...
          <div
            ...
            data-aos-anchor-placement="top-bottom"
            data-aos-delay="400"
            className="box w-full h-[350px] bg-sky-400 rounded-lg shadow-lg"
          >
